...
import { useInfiniteFlights, useExportFlights } from "@/hooks/api/useFlights";
    ...
    <div className="space-y-8 p-6">
      ...
      <GenomicCard>
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <Button 
            variant="outline"
            onClick={() => exportFlights.mutate('csv')}
            disabled={exportFlights.isPending}
          >
            {exportFlights.isPending ? (
              <>
      ...
      <div className="space-y-6">
        ...
        {/* Load More Button */}
        {!isLoading && filteredAnalyses.length > 0 && hasNextPage && (
